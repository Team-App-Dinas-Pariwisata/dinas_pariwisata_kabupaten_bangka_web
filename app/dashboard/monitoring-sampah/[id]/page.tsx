...
interface LaporanDeteksiDetail extends Record<string, unknown> {
  id: number;
  nama_pelapor?: string | null;
  lokasi_id?: string | null;
  lokasi_jenis?: string | null;
  ...
  deteksi_utama?: string | null;
  confidence?: number | string | null;
  jumlah_objek?: number | null;
...
export default async function DetailMonitoringSampah({
  ...
  const data = await getById<LaporanDeteksiDetail>("laporan_deteksi", id);
