...
CREATE TABLE IF NOT EXISTS notifikasi (
  ...
  target_role ENUM('admin','petugas') NOT NULL COMMENT 'Role penerima notifikasi',
  target_user_id INT UNSIGNED NULL COMMENT 'NULL = broadcast ke semua user dengan role tsb',
  ...
  INDEX idx_target_unread (target_role, is_read, created_at DESC),
